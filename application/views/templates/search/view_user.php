...
if(empty($list_data) == false && empty($user_data) == false){
    
    $address = urlencode($list_data->state . "+" . $list_data->zip_code . "+" . $list_data->city);
    
}else if(empty($employer_data) == false){
    
    $address = urlencode($employer_data->employer_state . "+" . $employer_data->employer_zip . "+" . $employer_data->employer_city);
...
?>
    	...
    	<h3 class="provider_title"><?=$employer_data->employer_name?></h3>
    	<div class="provider-address"><?=$employer_data->employer_address?></div>
    	<div class="provider-address"><?=$employer_data->employer_city?>,<?=$employer_data->employer_state?>,<?=$employer_data->employer_country?> ,<?=$employer_data->employer_zip?></div>
    	<div class="provider-address"><?=$employer_data->employer_phone?></div>
    	<div class="provider-address"><?=$employer_data->employer_email?></div>
