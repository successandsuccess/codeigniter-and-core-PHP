                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-lg-10">
                                ...
                                <?=form_input('username', set_value('username', $employee->{'username'}), 'class="form-control " id="" placeholder="" required')?>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-lg-10">
                                ...
                                <?=form_input('email', set_value('email', $employee->{'email'}), 'class="form-control " id="" placeholder="" required')?>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-lg-10">
                                ...
                                <?=form_input('password', set_value('password', $employee->{'password'}), 'class="form-control " id="" placeholder="" required')?>
...
echo get_ol1($permissions);



function get_ol1 ($array, $child = FALSE){
...
//			echo $key.' : '.$item;
			...
			$pos = $CI->input->post('permission['.$item['id'].']');
			...
			if (isset($item['children']) && count($item['children'])) {
				...
				$str .= '<ul class="checkbox2">'.get_ol1($item['children'], TRUE).'</ul>';
