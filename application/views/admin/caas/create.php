...
<?=form_open(NULL, array('class' => 'form-horizontal edit-form', 'role'=>'form','enctype'=>"multipart/form-data"))?>
    <input type="hidden" value="22.7195687, 75.85772580000003" id="inputGps" name="gps">
    <div class="col-md-12">
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="first_name" value="<?=set_value('first_name')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="last_name" value="<?=set_value('last_name')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="employer" value="<?=set_value('employer')?>" class="form-control " required="required" />
    	<span class="error-span"><?php echo form_error('employer'); ?></span>
    </div>
</div>
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="facility" value="<?=set_value('facility')?>" class="form-control " required="required" />
    	<span class="error-span"><?php echo form_error('facility'); ?></span>
    </div>
</div>
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="email" name="email" value="<?=set_value('email')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="address" value="<?=set_value('address')?>" class="form-control " id="autocomplete"  required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="city" value="<?=set_value('city')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="state" value="<?=set_value('state')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="country" value="<?=set_value('country')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="zip" value="<?=set_value('zip')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="phone" value="<?=set_value('phone')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="phone_2" value="<?=set_value('phone_2')?>" class="form-control " />
