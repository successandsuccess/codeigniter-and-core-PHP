...
for($i=18;$i>=70;$i--){
?>
<option value="<?=$i?>" <?=$this->input->get('age')==$i?'selected':''?> ><?=$i?></option>
<?php	
}
?>
</select>
...
<div class="form-group" >
	<label class="col-lg-2 control-label">Certified Years</label>
    <div class="col-md-10">
...
?>
<option value="<?=$i?>" <?=$this->input->get('years')==$i?'selected':''?> ><?=$i?></option>
<?php	
}
?>
</select>
