...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="employer" value="<?=set_value('employer',$form_data->employer)?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="facility" value="<?=set_value('facility',$form_data->facility)?>" class="form-control " required="required" />
