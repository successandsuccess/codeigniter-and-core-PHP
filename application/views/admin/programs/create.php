...
<div class="form-group" >
	<label class="col-lg-2 control-label">Program Director</label>
    <div class="col-md-10">
		<input type="text" name="name" value="<?=set_value('name')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="alumni" value="<?=set_value('alumni')?>" class="form-control " required="required" />
    	<span class="error-span"><?php echo form_error('alumni'); ?></span>
    </div>
</div>
