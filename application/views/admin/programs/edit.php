...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="name" value="<?=set_value('name',$form_data->name)?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="alumni" value="<?=set_value('alumni',$form_data->alumni)?>" class="form-control " required="required" />
