...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="certificate_no" value="<?=set_value('certificate_no')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="text" name="company_name" value="<?=set_value('company_name')?>" class="form-control " required="required" />
...
<div class="form-group" >
    ...
    <div class="col-md-10">
		<input type="url" name="website" value="<?=set_value('website')?>" class="form-control " />
