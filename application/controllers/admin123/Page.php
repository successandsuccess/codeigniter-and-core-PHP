...
class Page extends Admin_Controller{
	...
	public function __construct(){
		...
		$this->data['display_list'] =  array('home','affiliate register');
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
			...
			$data = $this->comman_model->array_from_post(array('template','top_menu','bottom_menu','name','description','display'));
