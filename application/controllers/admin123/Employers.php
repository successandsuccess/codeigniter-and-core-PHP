...
class Employers extends Admin_Controller{
	public $_table_names = 'employers';		//set table name
	public $_subView = 'admin/employers/';	//set subview load 
	public $_redirect = '/employers';			//set link with controller file name
	...
	public function create(){
		...
		$rules = array(
        		'name' 	=> array('field'=>'first_', 'label'=>'Name', 'rules'=>'trim'),
			   );
        ...
        if($this->form_validation->run() == TRUE){
            $data 	= array();
			$post1 =array('name','email','address','city','state','zip','country','phone','website','gps',);
