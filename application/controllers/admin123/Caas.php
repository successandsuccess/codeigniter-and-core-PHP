<?php
class Caas extends Admin_Controller{
	public $_table_names = 'caas';		//set table name
	public $_subView = 'admin/caas/';	//set subview load 
	public $_redirect = '/caas';			//set link with controller file name
	...
	public function create(){
        ...
        if($this->form_validation->run() == TRUE){
            $data 	= array();
			$post1 =array('first_name','last_name','employer','facility','email','address','city','state','zip','phone','gps','country','phone_2','gender');
