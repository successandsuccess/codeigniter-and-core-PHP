                    ...
                    <table id="memberTable" class="table sorttable table-striped table-bordered nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a href="?content=../blog/admin/AddNewBlog&li_class=Blog&act=edit&id=<?php echo $rec['id'] ?>" title="Edit"><span class="glyphicon glyphicon-edit"></span></a><a onclick="confirmDelete($(this)); return false;" href="?content=../blog/admin/ViewAllBlogs&li_class=Blog&act=del&id=<?php echo $rec['id'] ?>" title="Delete"><span class="glyphicon glyphicon-trash"></span></a></td>
                            </tr>
                            <?php
                                }
                            }
