                    ...
                    <div class="ncca-right-block ">
                      <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="help" role="tabpanel" aria-labelledby="help-tab">
                            ...
                            <div class="midium-title title-bottom-border text-uppercase"><div class="row"><div class="col-sm-12"><p class="text-uppercase">CDQ HELP</p></div><div class="clearfix"></div></div></div>
							<div class="row align-items-center mb-3"><div class="col-sm-6"><a href="http://localhost/member/?content=content/cdqhistory">< Back</a></div><div class="col-sm-6 text-right"><button type="button" class="btn">Pay Now</button></div><div class="clearfix"></div></div>
