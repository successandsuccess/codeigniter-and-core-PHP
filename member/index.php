...
<html lang="en">
      ...
      <script>
        ...
        // Safari 3.0+ "[object HTMLElementConstructor]" 
...

         {
            ...
            $('head').append('<style>.card.announcement{ min-height: 161px; }</style>')
...

         {
            ...
            $('head').append('<style>@media only screen and (min-width: 767px){.card.announcement{ height: 171px; }}</style>')
   ...
   <?php
      ...
      require_once (BASE_PATH . "member/announcement/announcement.php");

      global $announcement;

      $announceResults = $announcement->readByAudience($_SESSION['user_role']);

      // print_r($announceResults); exit;
            ...
            <div class="ncca-section-inner">
               ...
               <?php
...

                  {
                      ...
                      echo "<p style='font-size: 2rem; line-height: 1.37; font-weight: 700;'>Account Retired</p><br><p>Account of <a href = 'mailto: " . $userObject->data['login']['email'] . "'>" . $userObject->data['login']['email'] . "</a> has been Retired.</p>";
...

                  {
                      ...
                      echo "<p style='font-size: 2rem; line-height: 1.37; font-weight: 700;'>Account De-certified</p><br><p>Account of <a href = 'mailto: " . $userObject->data['login']['email'] . "'>" . $userObject->data['login']['email'] . "</a> has been De-certified.</p>";
               ...
               <div class="row">
                     ...
                     <div class="page-block block-border page-block-margin">
                        ...
                        <div class="ncca-contact">
                           ...
                           <ul>
                              ...
                              <li>Shaniqua Simmons</li>

                              <li><a href="#">877-290-5555</a></li>

                              <li><a href="#">shaniqua@gmail.org</a></li>
                  ...
                  <div class="col-lg-8 main-container">
                     ...
                     <div class="ncca-right-block block-border ncca-right-padding page-block-margin" style="background-color:#C1002D;">
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-6 pr-0 jk-60">
                                       ...
                                       <div class="ncca-welcome">
                                          ...
                                          <h3 class="big-title announcement" style="font-size: 28px;">Welcome back, <?php echo $userObject->data["generalinfo"]["f_name"]; ?>.</h3>
                                             ...
                                             ?>
                                                ...
                                                <div class="card announcement">
                                                      ...
                                                      <div class="card-header announcement" style="background: none;">
                                                         ...
                                                         <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-6">
                                                               ...
                                                               <div class="announcement-date">
                                                                  ...
                                                                  <?php echo date('m/d/y', strtotime(str_replace('-','/', $announceResult['created'])));?>

                                                               </div>

                                                            </div>

                                                            <?php if($announceResult['button'] != '') {?>

                                                               <div class="col-md-6 col-sm-6 col-6">

                                                                  <div class="announcement-button" style="text-align: right;">

                                                                     <button class="announcement-btn"><?php echo strtoupper($announceResult['button']);?></button>
                                                         ...
                                                         <h3 style="font-size: 20px;"><?php echo strtoupper($announceResult['subject']);?></h3>  

                                                      </div>

                                                      <div class="card-body announcement" style="padding-top:0px;">

                                                         <?php echo $announceResult['contents'];?>
                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-4 left-side-bar">
                           ...
                           <div class="page-block block-border page-block-margin">
                                             ...
                                             <ul>
                                                ...
                                                <li><b>Certified Through: </b> <span><?php
...

                                                   {
                                                         ...
                                                         else if($userObject->status["certification_end"] == "12/31/1969")
                                             ...
                                             <ul>
                                                ...
                                                <?php
...

                                                   {
                                                       ...
                                                       // print_r($userObject->data["university_info"]["actual_graduation_date"]); exit;

                                                       $graduation = date("m/d/Y", strtotime($userObject->data["university_info"]["actual_graduation_date"]));
...

                                                   {
                                                       ...
                                                       $graduation = $userObject->data["university_expected_date"]["Expected_Graduation"];

                                                   }

                                                   // print_r($graduation); exit;
                                                ...
                                                <?php
                                                   ...
                                                   // if(isset($userObject->data["university_info"]["actual_grad_year"]) == true){

                                                   // print_r("first_year"); exit;
                              ...
                              <div class="ncca-contact">
                                 ...
                                 <ul>
                                    ...
                                    <li><a href="#">212-708-9969</a></li>

                                    <li><a href="#">fiona@badapple.org</a></li>
                           ...
                           <div class="facebook-icon page-block">
                              ...
                              <a href="#" style="cursor: not-allowed; display:none;" class="facebook"><i class="fab fa-facebook-square"></i> <span>Share on facebook</span></a>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                       ...
                                       <div class="page-block block-border page-block-margin">
                                          ...
                                          <div class="cme-block-head ncca-right-padding"  style="min-height: 151px;">
                                          ...
                                          <div class="cme-block-bottom page-block" style="padding-left: 19px;">
