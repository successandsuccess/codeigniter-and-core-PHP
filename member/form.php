                 ...
                 <div class="tab-menu">
                    ...
                    ?>
                 	  <ul class="category-slider category-tab nav owl-carousel owl-theme tabs" id="category-tab" role="tablist">
                        ...
                        <li class="tab-link <?php if($current == 'current10') { echo 'current'; }; ?>" data-tab="tab-10" onclick='document.getElementById("belong_to_othermembership2").checked=true; document.getElementById("memberships-div").style.display = "none";'>Memberships</li>
                    </ul>
                 </div>
            </div>
                    ...
                    <form id="GeneralInfo_Form" name="GeneralInfo_Form"  action="editProfile/tab1.php?tab=current2" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row">
                            <div class="col4">
                                ...
                                <input type="text" onchange="" value="<?php if((!isset($row_general_info->title)) && empty($row_general_info->title) ) { echo $row_general_info->title; } else { echo ''; }     ?>" id="general_info_form_field0" minlength="8" name="title" class="form-input" >
                                <!-- <input type="text" onchange="" value="<?php if((!isset($row_general_info->title)) && empty($row_general_info->title) ) { echo $row_general_info->title; } else { echo ''; }     ?>" id="general_info_form_field0" minlength="8" name="title" class="form-input bg-input" > -->
                                <!--p class="msg">Assigned by Admin</p-->
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <select  class="form-input" name="alma_mater" onchange="autofill(this)">
                                    <option value="">Select University</option>
                                                ...
                                                ?>
                                                    ...
                                                    <!-- <option  value="<?php echo $rowState->id;?>" <?php if($rowState->id == $final_result_university_id->University_id) { echo "Selected";} else { echo ""; } ?>><?php echo $rowState->University_Name;?></option> -->
                                                <?php }
                                                } 
                                                else 
                                                {
...
?>
 ...
 -->
                ...
                <div class="row">
                    ...
                    <div class="row" id="other_data2"  <?php if( ! in_array("Other",$employment_info_type_setting_1)){ echo "style='display:none;'";} ?> >
                    ...
                    <div class="row margin-top-20">
                     ...
                     <div class="row" id="other_data3" <?php if( ! in_array("Other",$employment_info_type_setting_2)){ echo "style='display:none;'";} ?> >
...
<label>Administration<p class="msg msg3 lighter">e.g. practice group management, hospital committees</p></label>
                ...
                <div id="tab-8" class="tab-content <?php if($current == 'current8') { echo 'current'; }; ?>">
                    ...
                    <div class="row" id="offer_benefit_other"  <?php if( ! in_array("Other",$other_data_val)){ echo "style='display:none;'";} ?> >
                    ...
                    <div class="row" id="retirement_plan_other" <?php if(! in_array("Other",$other_data_val_new)){ echo "style='display:none;'";} ?> >
                ...
                <div id="tab-9" class="tab-content  <?php if($current == 'current9') { echo 'current'; }; ?>">
                    <form id="employe_skills_form" name="employe_skills_form"  action="editProfile/tab1.php?tab=current10" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="row lang_communicate" <?php if($employee_skills->other_than_english != "Yes" ){ echo "style='display:none;'";} ?> id="langcommunicate_other_skill">
                        ...
                        <div class="row" id="specialties_other" <?php if( ! in_array("Other",$specialties_all_data_val)){ echo "style='display:none;'";} ?>>
