...
$photo_name = $blastemail->viewPhoto($_SESSION['admin_id'], getSenderFullName($_SESSION['admin_email']));
        ...
        <form id="emailAdminForm" action="../emailblast/admin/BlastEmailproc.php" method="post" enctype="multipart/form-data"  autocomplete="off" >
                ...
                <div class="col-md-8">
                    ...
                    <div class="form-group border-b-1">
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <input type="text" name="" readonly="true" style="background-color: white" class="form-control border-0" value="<?= getSenderFullName($_SESSION['admin_email'])?> -  You." />
            ...
            <div class="form-group border-b-1">
                ...
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="to_mail" id="to_mail" class="form-control border-0" value="" />
                    </div>
            ...
            <div class="form-group border-b-1">
                <div class="row">
                    ...
                    <div class="col-md-11">
                        <input type="text" name="cc" id="cc" class="form-control border-0" value="" />
                    </div>
                </div>
            </div>
				...
				<div class="row">
					...
					<div class="col-md-12" style="height:120px;">
						<div class="profile_photo" id="profile_photo" style="background-image: url('../<?php
									...
									<div align="center"><i class="fa fa-camera" style="color:#ffffff; padding-top:35%"></i><br><font style="color:white">Edit picture</font><input type="file" class="form-control" style="cursor:pointer; margin-top: -75px; opacity:0; height: 100px;" id="add_sender_img" name="add_sender_img" accept="image/x-png,image/gif,image/jpeg" /></div>
...
$("#add_sender_img").change(function() {
