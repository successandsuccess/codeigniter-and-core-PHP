                         ...
                         <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                          <div class="block-border ncca-right-padding">
                            <p class="midium-title title-bottom-border text-uppercase">Read New Message</p>       
                                            ...
                                            <div class="row">
                                                <div class="col-md-24">
                                                    <h3 class="fs-14 mb-1 w-4">From: <span style="color:#969696;">Soren
                                                            Campbell</span> <span class="text-right float-right">X</span>
                                                    </h3>
                                                </div>
                                            ...
                                            <div class="text-right my-3">
                                                ...
                                                <a href="emailreplyview.php" class="btn btn-primary px-4 cl-fff">
