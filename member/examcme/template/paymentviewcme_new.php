...
<div class="modal fade" id="paymentContentModal_cme"  role="dialog" style="display:none;">
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content paymentContent">
         ...
         <?php
            if (($cmehistory->checkCOVIDCME($action_title, $cme_year)) == 0)
            {
            ?>
         <div class="row section1">
            ...
            <div class="col-md-6">
               <ul>
                  <li><a>CAA Name: <span><?php
                     echo $userObject->data["login"]['full_name'];
                     ?></span></a></li>
                  <li><a>Amount due: <span>$<?php
                     echo $pay_amount;
                     ?></span></a></li>
                  <li><a>Due date: <span>6/1/<?php
                     echo ($cme_year + 2);
                     ?></span></a></li>
                  <li><a>Date paid: <span><?php
                     echo date('m/d/Y');
                     ?></span></a></li>
            ...
            <form id="frmStripePaymentCME" action="" method="post">
               <div class="row">
                  ...
                  <div class="col-md-5">
                     ...
                     <input type="hidden" id="cme_name" name="cme_name" value="<?php
                        echo $userObject->data["login"]['full_name'];
                        ?>"/>
                     <input type="hidden" id="cme_date" name="cme_date" value="<?php
                        echo $cme['due_date'];
                        ?>"/>
                     <input type="hidden" id="amount" name="amount" value="<?php
                        echo $main_amount;
                        ?>"/>
                     <input type="hidden" id="due_date" name="due_date" value="<?php
                        echo $cme['due_date'];
                        ?>"/>
                     <input type="hidden" id="late_date" name="late_date" value="<?php
                        echo $cme['due_date'];
                        ?>"/>
                     <input type="hidden" id="late_amount" name="late_amount" value="<?php
                        echo $late_amount;
                        ?>"/>
                     <input type="hidden" id="action_title" name="action_title" value="<?php
                        echo $action_title;
                        ?>"/>
                     <input type="hidden" id="pay_num" name="pay_num" value="<?php
                        echo $pay_num;
                        ?>"/>
                     <input type="hidden" id="cme_year" name="cme_year" value="<?php
                        echo $cme_year;
                        ?>"/>
         ...
         <div id="receiptmodal_body_cme" class="modal-content paymentContent" style="min-height: auto;">
            ...
            <div class="row section1" style="padding: 20px 15px 45px 15px">
               <div class="col-md-12">
                  ...
                  <h5>
                     <?php
                        echo $receipt_cme['receipt_title'];
                        ?>
                  </h5>
                  <p>for June 1, <?php
                     echo $cme_year;
                  ...
                  <div class="row">
                     <div class="col-md-5">
                        <ul>
                           <li><a>CAA name: <span><?php
                              ...
                              ?></span></a></li>
                           <li><a>Amount due: <span><?php
                              echo '$' . $cmehistory->readActionAmount($receipt_cme['amount_num']);
                              ?></span></a></li>
                           <li><a>Due date: <span><?php
                              echo "6/1/" . ($receipt_cme['cme_cycle_start'] + 2);
                              ?></span></a></li>
                           <li><a>Date paid: <span><?php
                              echo $receipt_date['mon'] . "/" . $receipt_date['mday'] . "/" . $receipt_date['year'];
                              ?></span></a></li>
                           <li><a>Amount paid: <span><?php
                              echo '$' . $cmehistory->readActionAmount($receipt_cme['amount_num']);
                              ?></span></a></li>
                     ...
                     <div class="col-md-6" style="border-style: solid; border-width: 2px;border-color: #e5e5e5; padding:0px; color:rgb(112, 112, 112);">
                        <div class="col-md-12"  align="left" style="margin-top:15px;">
                           Last 4 digits of credit card used for payment:<font id="final_digits" style="color: #28a745; font-size: 14px;"> <?php
                              if ($receipt_cme['card_num4'])
                              {
            ...
            <div class="row receipt_body">
               <div class="col-md-4">
                  ...
                  <h6>June 1, <?php
                     echo ($receipt_cme['cme_cycle_start'] + 2);
                     ?> - June 1, <?php
                     echo ($receipt_cme['cme_cycle_start'] + 4);
                     ?></h6>
               </div>
               <div class="col-md-8">
...
<div class="row section1">
   <div class="col-md-12">
      ...
      <p>
         Due to COVID-19, Deadline Extended to September 1, 2020
      </p>
                        ...
                        <ul>
                           ...
                           <li>
                              <a>
                                 ...
                                 <span>
                                    <?php
                                       echo "9/1/" . ($receipt_cme['cme_cycle_start'] + 2);
                                       ?>&nbsp;
                                    <!-- COVID-19 SECTION Start -->
                                    COVID-19
                                    <!-- COVID-19 SECTION End -->
