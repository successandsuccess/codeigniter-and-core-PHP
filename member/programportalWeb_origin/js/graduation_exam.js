			...
			if(data['statusCode'] == 1){
				...
				for(var i = 0; i < data['value'].length; i++){
					...
					if(data['value'][i]['Graduation_score'] == 0){
						...
						td_value += "<td><select class='form-control' id='Graduation_score" + data['value'][i]['id'] + "' onchange = 'javascript:Graduation_score(" + data['value'][i]['id'] + ")'><option value='0' selected = 'selected'>Select</option><option value='1'>Pass</option><option value='2'>Failed</option></select></td>";
						
					}
					
					if(data['value'][i]['Graduation_score'] == 1){
						
						td_value += "<td><select class='form-control' id='Graduation_score" + data['value'][i]['id'] + "' onchange = 'javascript:Graduation_score(" + data['value'][i]['id'] + ")'><option value='0'>Select</option><option value='1'  selected = 'selected'>Pass</option><option value='2'>Failed</option></select></td>";
						
					}
					
					if(data['value'][i]['Graduation_score'] == 2){
						
						td_value += "<td><select class='form-control' id='Graduation_score" + data['value'][i]['id'] + "' onchange = 'javascript:Graduation_score(" + data['value'][i]['id'] + ")'><option value='0'>Select</option><option value='1'>Pass</option><option value='2' selected = 'selected'>Failed</option></select></td>";
...
function check_submit(){
	...
	if(count_student > 0){
		...
		filter = {
			...
			Graduation_check: checked_options,
