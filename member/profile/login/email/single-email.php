			...
			<div class="col-md-12">
				<form id="email_form" name="email_form"  action="email_form.php" method="POST">	
					...
					<div class="col-md-12 general-info form-section" id="general-info">
						<div class="col-md-12">
							<strong>Single Email Form</strong>
						...
						<?php
							...
							<div class="row">
								<div class="col-md-8">
										<select class="js-example-basic-single" name="emails">
									</select>
									<input type="hidden" value="single_email" name="single_email">
								</div>
							</div>
						</div>
						<div class="col-md-12 save-cancel">
							<div class="row">
								<div class="col-md-offset-8 col-md-2">
									<input type="submit" name="single_submit" value="Send Email" class="form-control btn btn-danger">
								</div>
								<div class="col-md-2">
