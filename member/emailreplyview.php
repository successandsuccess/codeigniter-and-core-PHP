                         ...
                         <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                          <div class="block-border ncca-right-padding">
                            <p class="midium-title title-bottom-border text-uppercase">Read New Message</p>       
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                  <a href="emailviewall.php">&lt; Back</a>
                                                    <h3 class="fs-14 mb-1 w-6">From: You (Admin) Cynthia Maraugh</h3>
                                                    <h3 class="fs-14 mb-1 w-6">To: <span style="color:#969696;">Soren
                                                            Campbell</span> </h3>
                                                </div>
                                                <div class="col-md-12">
                                                    <p class="fs-14 text-md-right" style="color:#969696;">Mon, Dec 10,
                                                        2018, 10:56 AM
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="email-msg">
                                                ...
                                                <p>Thank you for providing us with your updated email address. Please
                                                    take a moment to review this information to ensure its accuracy.
                                                </p>
                                                <p>New email address: tommy@gmail.com</p>
                                                <p>Future communications will be sent to your new email address.
                                                    Additionally, any account alerts that were linked to your old email
                                                    address will be sent to your new email address. </p>
                                                <p>If the information is correct, no action is necessary. However, if
                                                    this information is incorrect, or if this change was made without
                                                    your consent, please call us immediately at 1-800-222-3444. Our
                                                    Customer Service Professionals are available to assist you Monday
                                                    through Friday, 7 AM to 8 PM; Saturday, 8:30 AM to 5 PM ET. </p>
                                            ...
                                            <div class="row">
                                                    <div class="col-md-12">
                                                        <h3 class="fs-14 mb-1 w-6">From: Soren Campbell</h3>
                                                        <h3 class="fs-14 mb-1 w-6">To: <span style="color:#969696;">You (Admin) Cynthia Maraugha</span> </h3>
                                                    </div>
                                                    <div class="col-md-12">
                                                ...
                                                <div class="email-msg mt-4">
                                                        <p>Thanks for the info… I will be there!
                                                        </p>
                                                    ...
                                                    <div class="reply">
                                            <a href="emailviewall.php" class="btn btn-outline-secondary my-5 px-3">
