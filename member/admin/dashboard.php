                <div id="dash-toggle" class="top-heading card">
                    <h2>Admin</h2>
                        ...
                        <div class="col-lg-3">
                            <div class="adminCard Cregistration2">
                                ...
                                <ul>
                                    ...
                                    <li class="gap20"></li>
                                    <li><b>2020 Expenses</b></li>
                                    <li>Office Expenses<span class="amount">$0</span></li>
                                    <li>Merchant <span class="amount">$289,555.98</span></li>
                                    <li>Test Committee<span class="amount">$1,385,945.55</span></li>
                                    <li>Travel<span class="amount">$289,555.69</span></li>
                                    <li>NBME <span class="amount">$1,385,945.55</span></li>
                                    <li>Other<span class="amount">$289,555.69</span></li>
                                    <li class="gap20"></li>
...
<script>jQuery("#dash-toggle").click();</script>