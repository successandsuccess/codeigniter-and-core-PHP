...
if(isset($_POST['general_info_form'])){
    ...
    $query = "select * from final_generalinform where user_id=".$_SESSION['user_id'];
    ...
    if($rowcount >0){
       ...
       $update_query = "UPDATE final_generalinform set title='".$title."',f_name='".$fname."',m_name ='".$mname."',l_name='".$lname."',suffix='".$suffix."',status='".$status."' WHERE user_id=".$_SESSION['user_id'];
