...
if(isset($_POST['contact_info_submit'])){
    ...
    $query = "select * from final_address_contact_information where user_id=".$_SESSION['user_id'];
    ...
    if($rowcount >0){
       ...
       $update_query = "UPDATE final_address_contact_information set address_1='".$address."',apt_suite='".$apt_suite."',city ='".$city."',state='".$state."',zip_code='".$zip_code."',country='".$country."',cell_phone='".$cell_no."',business_phone='".$business_no."',home_phone='".$home_no."',other_phone='".$other_no."',
