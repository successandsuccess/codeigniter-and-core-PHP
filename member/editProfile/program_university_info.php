...
if(isset($_POST['program_uni_submit'])){
	...
	**/
	...
	$query = "select * from final_program_university_info where user_id=".$_SESSION['user_id'];
