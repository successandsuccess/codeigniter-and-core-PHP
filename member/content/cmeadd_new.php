   ...
   <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
      <div class="add-cme-form block-border ncca-right-padding">
         <div class="midium-title title-bottom-border">
            <div class="row">
               <div class="col-sm-6">
                  <p class="text-uppercase">ADD CME</p>
               </div>
         ...
         <div class="cme-form-block fullwidth">
            <form id="frmAddCME" action="?content=content/cmeadd" method="post" enctype="multipart/form-data" onsubmit = "return validateForm()">
               <div class="form-group row">
                  <label class="col-sm-5 text-right align-self-center">Select (Choose File) to attach your CME document or certificate</label>
               ...
               <div class="form-group row">
                  <label class="col-sm-5 text-right align-self-center">Enter a description/name to the document you just uploaded</label>
                  <div class="col-sm-7 align-self-center ">
                     <input type="text" name="file_name" id="file_name" class="form-control" placeholder="Enter the document name" required autofocus maxlength = "255" style="font-size: 14px">
                  </div>
               </div>
               <div class="form-group row">
                  <label class="col-sm-5 text-right align-self-center">How many Category | Anesthesia (ANES) credits does this document show?</label>
                  <div class="col-sm-7 align-self-center" data-tip="You may enter credit hours for &#013;&#010; Anesthesia or Other – not both"
                     >
                     <input type="text" name="anesthesia_credits" id="anesthesia_credits" maxlength="6" class="form-control reducesize" onclick="javascript:anesthesia_field()" required autofocus 
               ...
               <div class="form-group row">
                  <label class="col-sm-5 text-right align-self-center">How many Category || - General and Professional Development (GPD) credits does this document show?</label>
                  <div class="col-sm-7 align-self-center" data-tip="You may enter credit hours for &#013;&#010; Anesthesia or Other – not both">
