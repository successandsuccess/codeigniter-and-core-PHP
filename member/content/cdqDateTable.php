<table class="table table-bordered whiteheading" style="text-align:center;">
   <thead style="font-size:15px;">
      <tr>
         <th colspan="2">To maintain certification, CDQ Exam is taken every ten years. Choose one option below:</th>
      </tr>
            ...
            <?php
               if (isset($_GET["cdq_month"]) && $_GET["cdq_month"])
               {
                   ...
                   if (empty($cdq_historys) == true)
                   {
                       ...
                       if( in_array($_SESSION['user_id'], $late_CDQ_covid_users ) && $nowDay['year'] == 2020 )
                       {
