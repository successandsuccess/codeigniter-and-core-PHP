...
/* PROTECTED PROPERTIES ************************************************************************ */
	...
	protected $_extensions = array(
		'text'    => 'txt|[sp]?html?|css|jse?|php\d*|pr?l|pm|cgi|inc|csv|py|asp|ini|sql|cfg|bat|sh|json|xml|xslt?|xsd|xul|rdf|dtd|wsdl|log|htaccess',
...
/* PROTECTED METHODS *************************************************************************** */
	...
	protected function _viewModified() {
		return "changed:'$this->changed',changedTimeStamp:" . (int) @strtotime($this->changed);
	}
